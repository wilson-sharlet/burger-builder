...
const mapDispatchToProps = dispatch => ({
    addIngredientHandler: (ingredient) => dispatch({ type: actions.ADD_INGREDIENT, ingredient }),
    removeIngredientHandler: (ingredient) => dispatch({ type: actions.REMOVE_INGREDIENT, ingredient }),
})
